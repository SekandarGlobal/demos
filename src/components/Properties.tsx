const properties = [
  {
    ...
    tag: "Featured",
    lifestyle: "Full-floor living above the Manhattan skyline with 360-degree views",
  },
  {
    ...
    tag: "New Listing",
    lifestyle: "120 feet of private Pacific coastline with detached guest house",
  },
  {
    ...
    tag: "Exclusive",
    lifestyle: "Belle Epoque estate with private harbor berth and vineyard",
  },
  {
    ...
    tag: "Premium",
    lifestyle: "Triple-height atrium with retractable glass walls over the marina",
  },
  {
    ...
    tag: "Heritage",
    lifestyle: "Grade II listed townhouse restored with period-accurate millwork",
  },
  {
    ...
    tag: "Waterfront",
    lifestyle: "Contemporary clifftop compound with infinity pool and screening room",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {properties.map((property, index) => (
            <div key={index} className="property-card group rounded-2xl overflow-hidden bg-dark-800/50 border border-white/5 hover:border-gold-500/20">
              ...
              <div className="p-6">
                ...
                <p className="text-white/40 text-sm mb-2 flex items-center gap-1.5">
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
                ...
                <a
                  href="#contact"
                  className="block w-full text-center py-3 border border-gold-500/20 text-gold-400 text-sm rounded-xl tracking-wider uppercase hover:bg-gold-500/10 hover:border-gold-500/40 transition-all duration-300"
                >
